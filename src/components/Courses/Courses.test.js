  ...
  edges: [
    {
      'node': {
        ...
        'frontmatter': {
          ...
          'description': 'Accessibility refers to how people with disabilities can meaningfully use products...'
        }
      }
    },
    {
      'node': {
        ...
        'frontmatter': {
          ...
          'description': 'Welcome to the Awesome Learning Array Methods course. Over the next 5 lessons, ...'
        }
      }
    },
    {
      'node': {
        ...
        'frontmatter': {
          ...
          'description': 'Need help achieving the ideal layout for your feature? This course explains the...'
        }
      }
    },
    {
      'node': {
        ...
        'frontmatter': {
          'title': 'Data Types',
          'category': 'JS Fundamentals',
          'description': 'The focus of this course is to make you familiar with the nuance of the JavaScript...'
        }
      }
    },
    {
      'node': {
        ...
        'frontmatter': {
          ...
          'category': 'JS Fundamentals',
          'description': 'If you want to learn about JavaScript functions, then this is the course for you...'
        }
      }
    },
    {
      'node': {
        ...
        'frontmatter': {
          'title': 'Promises',
          'category': 'Async JS',
          'description': 'Asynchronous programming patterns are the cornerstone of Frontend. All of the...'
        }
      }
    },
  ]
