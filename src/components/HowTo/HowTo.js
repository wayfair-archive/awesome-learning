    ...
    <Content>
      <ContentSection title="Gathering A Group" className="HowTo-description">
        ...
        <ul className="HowTo-list">
          ...
          <li className="HowTo-listItem">
            Strive to find a group of roughly similar skill levels. This isn't
            an exact science, but mixing highly experienced and in-experienced
            folks together can sometimes lead to being too bored or too
            challenged on a subject.
          </li>
          <li className="HowTo-listItem">
            Set a time commitment early, and get buy-in. Shoot for an hour a
      ...
      <ContentSection title="During Your Lesson" className="HowTo-description">
        ...
        <ul className="HowTo-list">
          ...
          <li className="HowTo-listItem">
            Check the provided solutions if you get stuck, and don't be afraid
            to get derailed with discussions and research.
          </li>
        </ul>
      </ContentSection>
